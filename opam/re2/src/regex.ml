...
external cre2__pattern : t @ local -> string = "mlre2__pattern"
external cre2__options : t @ local -> Options.Private.C_repr.t = "mlre2__options"
...
module Stable = struct
  ...
  module V2 = struct
    ...
    module T = struct
      ...
      let%template[@alloc a @ m = (heap_global, stack_local)] to_repr (t @ m) =
